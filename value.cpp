...
Value SYM_LET = Value::CreateSpecialForm(SpecialForm::LET);
Value SYM_COND = Value::CreateSpecialForm(SpecialForm::COND);
Value SYM_ELSE = Value::CreateSpecialForm(SpecialForm::ELSE);
